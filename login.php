                    ...
                    <form name="form_login" action="?pagina=login" method="post">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">
                                <font size="4" color="white" face="Times New Roman">Senha</font>
                            </label>
                            <input type="password" name="senha" class="form-control" placeholder="Senha">
                            
                        </div>
                        <div class="botLogin mb-3">
                            <button name="validaLogin" type="submit" class="btn btn-danger ml-6">
                                <font size="4" color="white" face="Times New Roman">Enviar</font>
                            </button>
                        </div>
                    </form>
                </div>
